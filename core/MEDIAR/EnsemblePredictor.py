...
class EnsemblePredictor(Predictor):
    ...
    def _inference(self, img_data):
        ...
        if not self.use_tta:
            ...
            outputs_hflip_aux = self.hflip_tta.apply_deaug_mask(outputs_hflip_aux, apply=True)
            ...
            outputs_vflip_aux = self.vflip_tta.apply_deaug_mask(outputs_vflip_aux, apply=True)
            ...
            pred_mask_aux[0] = (outputs_aux[0] + outputs_hflip_aux[0] - outputs_vflip_aux[0]) / 3
            pred_mask_aux[1] = (outputs_aux[1] - outputs_hflip_aux[1] + outputs_vflip_aux[1]) / 3
            pred_mask_aux[2] = (outputs_aux[2] + outputs_hflip_aux[2] + outputs_vflip_aux[2]) / 3
